...
class LyukTest {
    ...
    void addOne() {
        ...
        Assertions.assertEquals(BErtek+1, B1.getErtek());
    }

    @Test
    void getJb() {
        Assertions.assertEquals(B1.getJb(), b1);
    }

    @Test
    void setZero() {
        B4.setZero();
        Assertions.assertEquals(B4.getErtek(), 0);
    }

    @Test
    void getErtek() {
        Assertions.assertEquals(B6.getErtek(), 5);
    }
    ...
    void getLyuk() {
        Lyuk ly = new Lyuk();
        ly = ly.getLyuk(a4, se);
        Assertions.assertEquals(A4, ly);
    }

    @Test
    void getoldal() {
        Assertions.assertEquals(A.getoldal(), true);
    }
}